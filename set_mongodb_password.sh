...
_word=$( [ ${MONGODB_PASS} ] && echo "preset" || echo "fixed" )
...
echo "=> Done!"
echo "user: $USER" > /data/db/.mongodb_password_set
echo "pass: $PASS" >> /data/db/.mongodb_password_set
echo "db: $DATABASE" >> /data/db/.mongodb_password_set
